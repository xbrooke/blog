...
.grid-card-modal-iframe {
  ...
  max-width: 900px; max-height: 60vh;
...
.grid-card-modal-close {
  position: absolute;
  top: 8px; right: 18px;
  font-size: 32px; color: var(--vp-c-text-1);
  cursor: pointer; font-weight: bold; z-index: 2;
}
.grid-card-video-wrap {
  width: 100%; aspect-ratio: 16/9;
  background: #000; border-bottom: 1px solid #f0f0f0;
  overflow: hidden;
}
.grid-card-video {
...
.grid-card:hover {
  ...
  box-shadow: 0 2px 8px var(--vp-c-shadow-3);
}
...
.grid-card-image {
  ...
  border-radius: 0; border: none; box-sizing: border-box;
}
.grid-card-content {
